package com.example.asniqbal.ziplibraymodule2
...
import com.self.ex.myapplication.ZipFileBulder
...
class ZipperActivity : AppCompatActivity(), FullCallback {


    var REQUEST_CHOOSER = 1234
    var REQUEST_CHOSER2 = 1122
    lateinit var filee: File
    var gotFile: Boolean = false
    ...
    fun reqStoragePermission() {
        PermissionManager.Builder().key(1)
            ...
            .callback(this@ZipperActivity)
            .ask(this@ZipperActivity)
    }
        ...
        AlertDialog.Builder(this)
            ...
            .setPositiveButton(android.R.string.ok) { dialogInterface, i ->
                ...
                if (!isNeverAskAgainChecked) {
                    ...
                    PermissionUtils.openApplicationSettings(this@ZipperActivity, R::class.java.getPackage().name)
                }
            }
